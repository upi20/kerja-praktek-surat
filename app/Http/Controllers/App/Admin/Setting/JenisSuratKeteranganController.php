...
class JenisSuratKeteranganController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $data['compact'] = $data;
        return view('app.admin.pengaturan.jenis_surat_keterangan', $data);
    }
    ...
    public function insert(Request $request): mixed
    {
        try {
            ...
            $model = new SuratKeteranganJenis();
    ...
    public function update(Request $request): mixed
    {
        try {
            ...
            $model = SuratKeteranganJenis::findOrFail($request->id);
    ...
    public function delete(SuratKeteranganJenis $model): mixed
    {
        try {
            $model->delete();
            return response()->json();
    ...
    {
        // list table
        $table = SuratKeteranganJenis::tableName;
        ...
        // Select =====================================================================================================
        $model = SuratKeteranganJenis::select(array_merge([
            DB::raw("$table.*"),
        ], $to_db_raw))
        ...
        $datatable->filter(function ($query) use ($model_filter, $query_filter, $table) {
            ...
            // tambah pencarian
            $search_add = ['nama', 'updated_by', 'created_by'];
