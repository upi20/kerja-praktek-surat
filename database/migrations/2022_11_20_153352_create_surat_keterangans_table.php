...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('surat_keterangans', function (Blueprint $table) {
            ...
            $table->bigInteger('jenis_surat_keterangan_id', false, true)->nullable()->default(null);
            ...
            $table->foreign('surat_id')
                ...
                ->nullOnDelete()
                ->cascadeOnUpdate();
            $table->foreign('jenis_surat_keterangan_id')
                ->references('id')->on('surat_keterangan_jenis')
                ->nullOnDelete()
                ->cascadeOnUpdate();
