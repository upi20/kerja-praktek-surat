            ...
            <form action="javascript:void(0)" id="MainForm" name="MainForm" method="POST" enctype="multipart/form-data">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                        ...
                        <textarea class="form-control" placeholder="Alamat Sekarang" id="alamat" name="alamat" required></textarea>
                    </div>
                </div>
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                        ...
                        <textarea class="form-control" placeholder="Alamat Asal" id="alamat_asal" name="alamat_asal" required></textarea>
                    </div>
                </div>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9 d-flex flex-row">
                        ...
                        <div class="w-100">
                            <input type="date" class="form-control date-input-str" value="" id="tinggal_sejak"
                                name="tinggal_sejak" required>
                        </div>
                    </div>
                </div>
            </form>
