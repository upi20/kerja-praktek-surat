            ...
            <table class="table table-hover" id="tbl_main">
                <thead>
                    <tr>
                        ...
                        <th class="text-nowrap">Ketua RW</th>
                ...
                <div class="modal-body">
                    <form action="javascript:void(0)" id="MainForm" name="MainForm" method="POST"
                        ...
                        <div class="form-group">
                            <label for="nomor" class="form-label">Nomor RW
                                <span class="text-danger">*</span>
                            </label>
                            <input type="number" class="form-control" placeholder="Nomor RW" id="nomor" name="nomor"
                                required>
                        </div>

                        <div class="form-group">
                            <label for="penduduk_id" class="form-label">Ketua Rukun Warga
                                <span class="text-danger">*</span>
                            </label>
