            ...
            <div class="modal-content modal-content-demo">
                ...
                <div class="modal-body">
                    <form action="javascript:void(0)" id="MainForm" name="MainForm" method="POST"
                        ...
                        <div class="row mb-1">
                            <label for="tanggal" class="col-sm-3 col-form-label">Tanggal Keluar
                                <span class="text-danger">*</span>
                            </label>
                            <div class="col-sm-9">
                                <span style="display: none;" id="tanggal_text"></span>
                                <input type="date" class="form-control date-input-str"
                                    placeholder="Tanggal Penduduk Keluar" id="tanggal" name="tanggal" required>
                            </div>
                        </div>
                        <div class="row mb-1">
                            <label for="tanggal" class="col-sm-3 col-form-label">Keterangan Keluar
                                <span class="text-danger">*</span>
                            </label>
                            <div class="col-sm-9">
                                <span style="display: none;" id="keluar_nama_text"></span>
                                <input type="text" class="form-control" placeholder="Keterangan Penduduk Keluar"
                                    id="keluar_nama" name="keluar_nama" required>
                            </div>
                        </div>
                        <div class="row mb-1">
                            <label for="keluar_keterangan" class="col-sm-3 col-form-label">Catatan Keluar
                                <span class="text-danger">*</span>
                            </label>
                            <div class="col-sm-9">
                                <span style="display: none;" id="keluar_keterangan_text"></span>
                                <textarea class="form-control" placeholder="Catatan Penduduk Keluar" id="keluar_keterangan"
                                    name="keluar_keterangan"></textarea>
                            </div>
                        </div>
                        <div class="row mb-1">
                            <label for="alamat_asal" class="col-sm-3 col-form-label">Alamat Tujuan</label>
                            <div class="col-sm-9">
                                <span style="display: none;" id="alamat_asal_text"></span>
                                <textarea class="form-control" placeholder="Alamat Tujuan Penduduk" id="alamat_asal" name="alamat_asal"></textarea>
                            </div>
                        </div>
                    </form>
                </div>
...
@section('javascript')
    ...
    <script>
        ...
        function input_form_data(data) {
            ...
            $('#keluar_nama').val(data.nama);
            $('#keluar_keterangan').val(data.keterangan);
        ...
        function view_form(view = null) {
            ...
            const keluar_nama_text = $('#keluar_nama_text');
            const keluar_keterangan_text = $('#keluar_keterangan_text');
            ...
            const keluar_nama = $('#keluar_nama');
            const keluar_keterangan = $('#keluar_keterangan');
            ...
            switch (view) {
                case 'insert-nik': // insert dengan nik yang sudah terdaftar yang bisa di ubah cuman status tombol reset ada
                    ...
                    keluar_nama_text.html(keluar_nama.val());
                    keluar_nama_text.hide();
                    keluar_nama.show();

                    keluar_keterangan_text.html(keluar_keterangan.val());
                    keluar_keterangan_text.hide();
                    keluar_keterangan.show();
                ...
                case 'view': // view data
                    ...
                    keluar_nama_text.html(keluar_nama.val());
                    keluar_nama_text.show();
                    keluar_nama.hide();

                    keluar_keterangan_text.html(keluar_keterangan.val());
                    keluar_keterangan_text.show();
                    keluar_keterangan.hide();
                ...
                default: // insert dengan nik yang belum terdaftar semua bisa di ubah tombol reset tidak ada
                    ...
                    status_kawin_text.html('');
                    status_kawin_text.show();
                    status_kawin.hide();

                    warga_negara_text.html('');
                    warga_negara_text.show();
                    warga_negara.hide();

                    negara_nama_text.html('');
                    negara_nama_text.show();
                    negara_nama.hide();
                    ...
                    keluar_nama_text.html('');
                    keluar_nama_text.hide();
                    keluar_nama.show();

                    keluar_keterangan_text.html('');
                    keluar_keterangan_text.hide();
                    keluar_keterangan.show();
