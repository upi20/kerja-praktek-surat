                    ...
                    <div id="collapse1" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne1">
                        <div class="panel-body">
                            <form action="javascript:void(0)" class="ml-md-3 mb-md-3" id="FilterForm">
                                ...
                                <div class="form-group float-start me-2" style="min-width: 250px">
                                    <label for="rw_filter">Diubah Oleh</label>
                                    <br>
            ...
            <table class="table table-hover" id="tbl_main">
                <thead>
                    <tr>
                        ...
                        <th class="text-nowrap">Nama Daerah</th>
                        <th class="text-nowrap">NO RW</th>
                        <th class="text-nowrap">NO RT</th>
                        <th class="text-nowrap">Ketua RT</th>
                ...
                <div class="modal-body">
                    <form action="javascript:void(0)" id="MainForm" name="MainForm" method="POST"
                        ...
                        <div class="form-group">
                            <label for="nama_daerah" class="form-label">Nama Daerah
                                <span class="text-danger">*</span>
                            </label>
                            <input type="text" class="form-control" placeholder="Kampung, Perumahan DLL"
                                id="nama_daerah" name="nama_daerah" required>
                        </div>

                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="rw" class="form-label">Nomor RW
                                        <span class="text-danger">*</span>
                                    </label>
                                    <input type="number" class="form-control" placeholder="Nomor Rukun Warga"
                                        id="rw" name="rw" required>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="nomor" class="form-label">Nomor RT
                                        <span class="text-danger">*</span>
                                    </label>
                                    <input type="number" class="form-control" placeholder="Nomor Rukun Tetangga"
                                        id="nomor" name="nomor" required>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="penduduk_id" class="form-label">Ketua Rukun Tetangga
                                <span class="text-danger">*</span>
                            </label>
            ...
            const new_table = table_html.DataTable({
                ...
                ajax: {
                    ...
                    data: function(d) {
                        ...
                        d['filter[rw_nomor]'] = $('#rw_filter').val();
                    }
                },
                columns: [{
                        data: null,
