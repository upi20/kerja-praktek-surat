                    ...
                    <div id="collapse1" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne1">
                        <div class="panel-body">
                            <form action="javascript:void(0)" class="ml-md-3 mb-md-3" id="FilterForm">
                                ...
                                <div class="form-group float-start me-2" style="min-width: 250px">
                                    <label for="jabatan_id_filter">Jabatan</label>
                                    <br>
                                    <select class="form-control" id="jabatan_id_filter" name="jabatan_id_filter"
                                        style="width: 100%;">
                                        <option value="" selected>Semua</option>
                ...
                <div class="modal-body">
                    <form action="javascript:void(0)" id="MainForm" name="MainForm" method="POST"
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" placeholder="Nomor Induk Pegawai" id="nip"
                                name="nip">
                        </div>

                        <div class="form-group">
                            <label for="penduduk_id" class="form-label">Penduduk
                                <span class="text-danger">*</span>
                            </label>
            ...
            const new_table = table_html.DataTable({
                ...
                ajax: {
                    ...
                    data: function(d) {
                        ...
                        d['filter[jabatan_id]'] = $('#jabatan_id_filter').val();
                    }
                },
                columns: [{
                        data: null,
        ...
        function editFunc(id) {
            ...
            $.ajax({
                ...
                success: (data) => {
                    ...
                    $('#nip').val(data.nip);
                    $('#penduduk_id')
                        .append((new Option(`${data.penduduk.nik} ${data.penduduk.nama}`, data.penduduk.id,
